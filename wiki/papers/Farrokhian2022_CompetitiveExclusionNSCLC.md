...
- Treatment dose implications connect to [[topics/evolutionary-control/_hub|evolutionary-control]] — specifically the [[concepts/adaptive-therapy|adaptive therapy]] rationale that competitive suppression of resistant cells by sensitive cells can be prolonged by judicious dosing; provides mechanistic grounding complementary to drug dependence work in [[papers/Maltas2023_DrugDependence|Maltas2023]].
